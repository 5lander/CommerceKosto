...
| [ADR-029](ADR-029-la-transferencia-en-dos-pasos-sobre-rutas-de-abastecimiento.md) | La transferencia pasa a **dos pasos sobre rutas declaradas**: despacho con alcance sobre el origen, recepcion con alcance sobre el destino, y lo que no llego se registra como **merma de traslado** en el destino con tipo propio. El transito es proyeccion del libro y **R2 gana un sumando** | 🟡 propuesto | P16-T |
