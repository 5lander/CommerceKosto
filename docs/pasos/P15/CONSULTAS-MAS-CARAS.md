...
### 1. 950 ms totales, 561 llamadas, 1.69 ms de media

```sql
SELECT "public"."item"."id", "public"."item"."name", "public"."item"."type", "public"."item"."unit_of_use", "public"."item"."yield", "public"."item"."group_id", "public"."item"."status", "public"."item"."price_confidence", "public"."item"."keeps_stock" FROM "public"."item" WHERE "public"."item"."company_id" = $1 ORDER BY "public"."item"."name" ASC OFFSET $2
```

### 2. 925 ms totales, 396 llamadas, 2.34 ms de media
...
### 3. 243 ms totales, 99 llamadas, 2.45 ms de media

```sql
SELECT "public"."purchase_article"."id", "public"."purchase_article"."item_id", "public"."purchase_article"."name", "public"."purchase_article"."brand", "public"."purchase_article"."supplier", "public"."purchase_article"."presentation_amount", "public"."purchase_article"."presentation_unit", "public"."purchase_article"."conversion_factor", "public"."purchase_article"."status" FROM "public"."purchase_article" WHERE "public"."purchase_article"."company_id" = $1 ORDER BY "public"."purchase_article"."name" ASC OFFSET $2
```

### 4. 229 ms totales, 396 llamadas, 0.58 ms de media

```sql
SELECT "public"."product"."id", "public"."product"."name", "public"."product"."type", "public"."product"."category", "public"."product"."status", "public"."product"."packaging_item_id" FROM "public"."product" WHERE "public"."product"."company_id" = $1 ORDER BY "public"."product"."name" ASC OFFSET $2
```

### 5. 208 ms totales, 363 llamadas, 0.57 ms de media
...
### 6. 182 ms totales, 363 llamadas, 0.50 ms de media
...
### 7. 145 ms totales, 396 llamadas, 0.37 ms de media
...
### 8. 129 ms totales, 99 llamadas, 1.30 ms de media
...
### 9. 108 ms totales, 396 llamadas, 0.27 ms de media
...
### 10. 47 ms totales, 5447 llamadas, 0.01 ms de media
